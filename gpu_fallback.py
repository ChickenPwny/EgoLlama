...
I'm currently in fallback mode, but I can still help with code, debugging, and general questions! 💖""")
        ...
        elif any(keyword in prompt.lower() for keyword in ['what can you', 'capabilities', 'help']):
            response_parts.append("""I'm a versatile AI assistant! 🎊
...
- Tables: chat_conversations, chat_messages, code_executions
...
This helps me find vulnerability information, research papers, and other resources! 🎉""")
        ...
        # Check for creative mode questions
        elif any(keyword in prompt.lower() for keyword in ['creative', 'mode', 'agency', 'cli']):
            response_parts.append("""I have creative mode! 🎨

Features:
- CLI with --creative flag
- Agency mode for proactive suggestions
- Innovative problem-solving approaches
- Extensible architecture

Use the CLI to launch creative mode! 💖""")
        
        # Default response
        else:
            response_parts.append(f"""I'm an AI coding assistant! 🎉
